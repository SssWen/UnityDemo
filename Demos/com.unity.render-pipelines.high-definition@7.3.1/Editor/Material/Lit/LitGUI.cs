...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class LitGUI : HDShaderGUI
    {
        ...
        {
            // 第一个Surface Options，Material Type 可以选择多种光照模型 SSS,Standard Shader,Anistropy iridescence Specular Color Translucent
            ...
            // We don't want distortion in Lit 这个不是默认
