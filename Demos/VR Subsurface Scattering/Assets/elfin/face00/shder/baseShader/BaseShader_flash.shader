Shader "Custom/BaseShader_flash"
{
	Properties
	{
		...
		// flash
		[ToggleOff] _Flash("Flash", float) = 0
		_FlashTex("FlashTex(R)", 2D) = "White"{}
		[NoScaleOffset]_FlashNoiseTex("_FlashNoiseTex(RGB)", 2D) = "White"{}
	...
	SubShader
	{
		...
		Pass
		{
			...
			// fun dream zone
			#pragma shader_feature _FLASH
			#pragma shader_feature _DENSITY
			#pragma shader_feature _FlashUVSet_0 _FlashUVSet_1 _FlashUVSet_2 _FlashUVSet_3
	...
	FallBack "VertexLit"
	CustomEditor "FunDreamBaseShaderGUI_flash"
}
