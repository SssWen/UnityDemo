#ifndef FUN_UNITY_STANDARD_SHADOW_INCLUDED
#define FUN_UNITY_STANDARD_SHADOW_INCLUDED
...
half MetallicSetup_FunDream_OneMinusReflectivity(half2 uv)
{
    half metallicity = _Metallic;
    #ifdef _METALLICGLOSSMAP
        metallicity = tex2D(_MetallicGlossMap, uv).r;
...
void vertShadowCaster_FunDream (VertexInput v
...
half4 fragShadowCaster_FunDream (UNITY_POSITION(vpos)
#ifdef UNITY_STANDARD_USE_SHADOW_OUTPUT_STRUCT
...
) : SV_Target
{
            ...
            clip (alpha - _Cutoff);
                ...
                // 修改回Unity的版本
                PreMultiplyAlpha(half3(0, 0, 0), alpha, MetallicSetup_FunDream_OneMinusReflectivity(i.tex), outModifiedAlpha);
