...
internal class FunDreamBaseShaderGUI_hair : ShaderGUI
{
    ...
    private static class Styles
    {
        ...
        public static GUIContent cutOffText = new GUIContent("CutOff", "Alpha CutOff");
        public static GUIContent glossText = new GUIContent("Gloss", "Gloss");
        public static GUIContent xCurveText = new GUIContent("X_Curve", "X Curve");
        public static GUIContent yCurveText = new GUIContent("Y_Curve", "Y Curve");
        public static GUIContent offsetText = new GUIContent("Offset", "Offset");
        public static GUIContent noiseTexText = new GUIContent("SpecOffset(G), SpecMask(B)", "G:SpecOffset B:SpecMask");

        public static GUIContent fuzzONText = new GUIContent("FuzzON", "Fuzz ON");
        public static GUIContent fuzzTexText = new GUIContent("FuzzTex(RGB)", "Fuzz Texture");
        public static GUIContent hairSpecColText = new GUIContent("HairSpecCol", "HairSpecCol");
        public static GUIContent hairSpecCol2Text = new GUIContent("HairSpecCol2", "HairSpecCol2");
        public static GUIContent hairSpecCol3Text = new GUIContent("HairSpecCol3", "HairSpecCol3");
        public static GUIContent offset2Text = new GUIContent("Offset2", "Offset2");
        public static GUIContent offset3Text = new GUIContent("Offset3", "Offset3");
        public static GUIContent smoothness2Text = new GUIContent("Smoothness2", "Smoothness2");
        public static GUIContent smoothness3Text = new GUIContent("Smoothness3", "Smoothness3");

        public static GUIContent fuzzColorText = new GUIContent("FuzzColor", "Fuzz Color");
        public static GUIContent wrapDiffuseText = new GUIContent("WrapDiffuse", "Wrap Diffuse");
        public static GUIContent fuzzRangeText = new GUIContent("FuzzRange", "Fuzz Range");
        public static GUIContent fuzzBiasText = new GUIContent("FuzzBias", "Fuzz Bias");
        public static GUIContent lacquerONText = new GUIContent("LacquerON", "Lacquer ON");
        public static GUIContent lacquerSmoothnessText = new GUIContent("LacquerSmoothness", "Lacquer Smoothness");
        public static GUIContent lacquerReflectionText = new GUIContent("LacquerReflection", "Lacquer Reflection");
    ...
    MaterialProperty specType = null;
    MaterialProperty gloss = null;
    MaterialProperty xCurve = null;
    MaterialProperty yCurve = null;
    MaterialProperty noiseTex = null;
    MaterialProperty offset = null;
    MaterialProperty offset2 = null;
    MaterialProperty offset3 = null;
    MaterialProperty hairSpecCol = null;
    MaterialProperty hairSpecCol2 = null;
    MaterialProperty hairSpecCol3 = null;
    MaterialProperty smoothness2 = null;
    MaterialProperty smoothness3 = null;


    MaterialProperty fuzzON = null;
    MaterialProperty fuzzTex = null;
    MaterialProperty fuzzColor = null;
    MaterialProperty wrapDiffuse = null;
    MaterialProperty fuzzRange = null;
    MaterialProperty fuzzBias = null;
    MaterialProperty lacquerON = null;
    MaterialProperty lacquerSmoothness = null;
    MaterialProperty lacquerReflection = null;
    ...
    public void FindProperties(MaterialProperty[] props)
    {
        ...
        xCurve = FindProperty("_XCurve", props);
        yCurve = FindProperty("_YCurve", props);
        noiseTex = FindProperty("_NoiseTex", props);
        offset = FindProperty("_Offset", props);
        offset2 = FindProperty("_Offset2", props);
        offset3 = FindProperty("_Offset3", props);
        hairSpecCol = FindProperty("_HairSpecCol", props);
        hairSpecCol2 = FindProperty("_HairSpecCol2", props);
        hairSpecCol3 = FindProperty("_HairSpecCol3", props);
        smoothness2 = FindProperty("_Smoothness2", props);
        smoothness3 = FindProperty("_Smoothness3", props);

        fuzzON = FindProperty("_FuzzON", props);
        fuzzTex = FindProperty("_FuzzTex", props);
        fuzzColor = FindProperty("_FuzzColor", props);
        wrapDiffuse = FindProperty("_WrapDiffuse", props);
        fuzzRange = FindProperty("_FuzzRange", props);
        fuzzBias = FindProperty("_FuzzBias", props);
        lacquerON = FindProperty("_LacquerON", props);
        lacquerSmoothness = FindProperty("_LacquerSmoothness", props);
        lacquerReflection = FindProperty("_LacquerReflection", props);
    ...
    public void ShaderPropertiesGUI(Material material)
    {
        ...
        EditorGUI.BeginChangeCheck();
        {
            ...
            if (material.GetFloat("_SpecularHighlights") == 1)
            {
                m_MaterialEditor.TexturePropertySingleLine(Styles.noiseTexText, noiseTex);
                if (material.GetTexture("_NoiseTex"))
                {
                ...
                m_MaterialEditor.ShaderProperty(xCurve, Styles.xCurveText.text, 0);
                m_MaterialEditor.ShaderProperty(yCurve, Styles.yCurveText.text, 0);

                GUILayout.Label("Spec1", EditorStyles.boldLabel);
                m_MaterialEditor.ShaderProperty(hairSpecCol, Styles.hairSpecColText.text, 0);
                m_MaterialEditor.ShaderProperty(offset, Styles.offsetText.text, 0);

                GUILayout.Label("Spec2", EditorStyles.boldLabel);
                m_MaterialEditor.ShaderProperty(hairSpecCol2, Styles.hairSpecCol2Text.text, 0);
                m_MaterialEditor.ShaderProperty(smoothness2, Styles.smoothness2Text.text, 0);
                m_MaterialEditor.ShaderProperty(offset2, Styles.offset2Text.text, 0);

                GUILayout.Label("Spec3", EditorStyles.boldLabel);
                m_MaterialEditor.ShaderProperty(hairSpecCol3, Styles.hairSpecCol3Text.text, 0);
                m_MaterialEditor.ShaderProperty(smoothness3, Styles.smoothness3Text.text, 0);
                m_MaterialEditor.ShaderProperty(offset3, Styles.offset3Text.text, 0);
                
            }



            //m_MaterialEditor.ShaderProperty(fuzzON, Styles.fuzzONText.text, 0);
            //if (fuzzON.floatValue == 1)
            //{
            //    m_MaterialEditor.TexturePropertySingleLine(Styles.fuzzTexText, fuzzTex);
            //    if (material.GetTexture("_FuzzTex"))
            //    {
            //        m_MaterialEditor.TextureScaleOffsetProperty(fuzzTex);
            //    }
            //        m_MaterialEditor.ShaderProperty(fuzzColor, Styles.fuzzColorText.text, 1);
            //    m_MaterialEditor.ShaderProperty(wrapDiffuse, Styles.wrapDiffuseText.text, 1);
            //    m_MaterialEditor.ShaderProperty(fuzzRange, Styles.fuzzRangeText.text, 1);
            //    m_MaterialEditor.ShaderProperty(fuzzBias, Styles.fuzzBiasText.text, 1);
            //}

            //m_MaterialEditor.ShaderProperty(lacquerON, Styles.lacquerONText.text, 0);
            //if (lacquerON.floatValue == 1)
            //{
            //    m_MaterialEditor.ShaderProperty(lacquerSmoothness, Styles.lacquerSmoothnessText.text, 1);
            //    m_MaterialEditor.ShaderProperty(lacquerReflection, Styles.lacquerReflectionText.text, 1);
            //}
    ...
    public override void AssignNewShaderToMaterial(Material material, Shader oldShader, Shader newShader)
    {
        ...
        BlendMode blendMode = BlendMode.Fade;
    ...
    static void SetMaterialKeywords(Material material, WorkflowMode workflowMode)
    {
        ...
        SetKeyword(material, "_ANISO", true);
        SetKeyword(material, "_HAIR", true);
        SetKeyword(material, "_NOISE_TEX", material.GetTexture("_NoiseTex"));
        //SetKeyword(material, "_FUZZ", material.GetFloat("_FuzzON") > 0);
        //SetKeyword(material, "_FUZZ_TEX", material.GetTexture("_FuzzTex"));
        //SetKeyword(material, "_LACQUER", material.GetFloat("_LacquerON") > 0);
